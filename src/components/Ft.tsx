    ...
    <section className="py-8 antialiased bg-gray-900 h-screen md:py-16 justify-center items-center flex">
        <div className="mx-auto grid max-w-7xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
            ...
            <div className="content-center justify-self-start md:col-span-7 md:text-start">
                <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white md:max-w-2xl md:text-5xl xl:text-6xl">Limited Time Offer!<br />Up to 50% OFF!</h1>
                <p className="max-w-2xl text-gray-400 md:mb-12 md:text-lg mb-3 lg:mb-5 lg:text-xl">Don't Wait - Limited Stock at Unbeatable Prices!</p>
                <a href="#" className="inline-block rounded-lg px-6 py-3.5 text-center font-medium text-white focus:outline-none focus:ring-4 bg-[#2563eb] hover:bg-[#1d4ed8] focus:ring-[#1e40af]">Shop Now</a>
            </div>
        </div>
    </section>
  )
